  ...
  describe '#calculate_tenders_and_tips' do
    context 'with discount' do
      it 'returns the proper tenders and values' do
        ...
        (calculator.gift_card_payment_to_apply).should be(0)
        (calculator.gift_card_tip_to_apply).should be(0)
        (calculator.levelup_payment_to_apply).should be(0)
        (calculator.levelup_tip_to_apply).should be(0)
      end
    end
    ...
    context 'with discount and gift card with tip' do
      it 'returns the proper tenders and values' do
        ...
        (calculator.gift_card_payment_to_apply).should be(500)
        (calculator.gift_card_tip_to_apply).should be(500)
        (calculator.levelup_payment_to_apply).should be(0)
        (calculator.levelup_tip_to_apply).should be(0)
      end
    end
    ...
    context 'with discount, gift card, levelup tender and levelup tip' do
      it 'returns the proper tenders and values' do
        ...
        (calculator.gift_card_payment_to_apply).should be(60)
        (calculator.gift_card_tip_to_apply).should be(0)
        (calculator.levelup_payment_to_apply).should be(40)
        (calculator.levelup_tip_to_apply).should be(50)
      end
    end
    ...
    context 'with gift card, levelup tender' do
      it 'returns the proper tenders and values' do
        ...
        (calculator.gift_card_payment_to_apply).should be(500)
        (calculator.gift_card_tip_to_apply).should be(0)
        (calculator.levelup_payment_to_apply).should be(500)
        (calculator.levelup_tip_to_apply).should be(0)
      end
    end
    ...
    context 'with gift card, levelup tender and levelup tip' do
      it 'returns the proper tenders and values' do
        ...
        (calculator.gift_card_tip_to_apply).should be(0)
        (calculator.levelup_payment_to_apply).should be(500)
        (calculator.levelup_tip_to_apply).should be(500)
      end
    end
    ...
    context 'with levelup tender and levelup tip' do
      it 'returns the proper tenders and values' do
        ...
        (calculator.gift_card_payment_to_apply).should be(0)
        (calculator.gift_card_tip_to_apply).should be(0)
        (calculator.levelup_payment_to_apply).should be(1500)
        (calculator.levelup_tip_to_apply).should be(500)
      end
    end
  end
